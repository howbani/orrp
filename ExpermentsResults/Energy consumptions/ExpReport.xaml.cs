...
namespace ORR.ExpermentsResults.Energy_consumptions
{
    class ResultsObject
    {
    ...
    public partial class ExpReport : Window
    {
        ...
        public ExpReport(MainWindow _mianWind)
        {
            ...
            double NumberofDeliveredDataPackets = Convert.ToDouble(PublicParamerters.NumberofDeliveredDataPackets);
            ...
            //double avergaeRedundan = Convert.ToDouble(PublicParamerters.TotalReduntantTransmission) / NumberofDeliveredDataPackets;
            ...
            List.Add(new ValParPair() { Par = "Protocol", Val = "ORR" });
