...
namespace ORR.Dataplane
{
    ...
    public class PublicParamerters
    {
        ...
        public static int SizeofNetwork { get; set; }
        public static double ORR_Alfa = 1.0;
        public static int UpdateORReveryXseconds 
        {
            get 
            {
                return 100;
        ...
        public static long NumberofDatePackets { get; set; }
        public static long NumberofUpdatePackets { get; set; }
        public static long NumberofDeliveredDataPackets { get; set; }
        ...
        public static double RoutingUpdateLength = 1024;//bit
